...
const Work = () => {
  ...
  return (
    <Layout>
      <Hero headline={work.hero.headline} subheadline={work.hero.subheadline} plate="navy" rightElement={<PyramidAnimation axis="y" speed={0.02} />} />
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <ProofTiles tiles={work.tiles.map(t => ({ ...t, href: '#' }))} />
        </div>
      </section>
