...
const Services = () => {
  ...
  usePageMeta({
    title: locale === 'ar' ? 'الخدمات | أمجد عثمان' : 'Services | Amjad Osman',
    description:
      locale === 'ar'
  ...
  return (
    <Layout>
      <Hero
        ...
        headline={locale === 'ar'
          ? 'ثلاث طرق أساعد بها الفرق على الظهور بشكل أقوى والعمل بشكل أنظف وأتمتة العمل المتكرر.'
          : 'Three ways I help teams look sharper, run cleaner, and automate repeat work.'}
      ...
      <section className="py-16 md:py-24 bg-muted">
        <div className="container mx-auto px-4 md:px-6">
          <SectionHeader
            eyebrow={locale === 'ar' ? 'العمل معاً' : 'Working together'}
        ...
        <div className="container mx-auto px-4 md:px-6">
          <SectionHeader
            ...
            subheadline={locale === 'ar'
              ...
              : 'You do not need to define the whole roadmap before reaching out. I start with the bottleneck that matters now, scope it clearly, and move from there.'}
            variant="poster"
          />
          <Steps
            steps={locale === 'ar'
              ...
              : [
                  { title: 'Share the bottleneck', description: 'Tell me what is slowing the business down or what needs to feel stronger.' },
                  { title: 'Get a focused recommendation', description: 'I point you to the right service, likely starting shape, and what to tackle first.' },
      ...
      <CTABand
        ...
        description={locale === 'ar'
          ? 'سأساعدك في اختيار أفضل مسار بداية وأوضح لك التسعير.'
          : "I can help you pick the best starting track and show the pricing."}
