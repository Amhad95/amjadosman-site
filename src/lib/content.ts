...
export const siteContent = {
    ...
    list: [
      {
        ...
        whoFor: "Teams documenting a process for the first time or standardizing execution.",
        implementLink: { label: "Want us to implement this?", href: "/pricing#internal-execution" },
      },
      {
        title: "Brand Consistency Audit",
        outputs: ["Consistency report", "Priority fixes", "Guideline gaps"],
        whoFor: "Teams with inconsistent brand assets across documents and web.",
        implementLink: { label: "Want us to implement this?", href: "/pricing#external-credibility" },
      },
      {
        title: "Landing Page Critique",
        outputs: ["Conversion friction notes", "Hierarchy fixes", "Clarity improvements"],
        whoFor: "Teams optimizing a marketing page for better conversion.",
        implementLink: { label: "Want us to implement this?", href: "/pricing#external-credibility" },
      },
    ],
    emailCapture: {
  ...
  work: {
    ...
    tiles: [
      ...
      {
        title: "Sample SOP pack (TOC + excerpt)",
        description: "Table of contents and excerpt from a delivered procedure library.",
        cta: "View sample",
      },
      {
        title: "Before and after landing page",
        description: "Conversion-focused redesign with rationale explained.",
        cta: "View comparison",
      },
      {
        title: "Brand system excerpt",
        description: "Guideline pages showing identity system in use.",
        cta: "View excerpt",
      },
    ],
    requestCta: {
